        ...
        <div class="auth-container">
          ...
          <form method="post" action="index.php?action=signup" class="custom-form">
            ...
            <div class="form-group">
              ...
              <input type="password" name="password_confirm" id="password_confirm" class="form-control" onkeyup="checkEqualityOnPasswords()" />
            </div>
            <div class="form-group">
              <div class="row">
                <div class="col-md-6">
...
<script type="text/javascript" src="beta/equality_pw.js"></script>